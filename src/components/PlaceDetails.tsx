...
import { Navigation, BookmarkIcon, Share2, Edit, MapPin, Building, Tag, Clock } from 'lucide-react';
...
const PlaceDetails: React.FC<PlaceDetailsProps> = ({ place, onClose }) => {
  ...
  return (
    <Sheet open={!!place} onOpenChange={() => onClose()}>
      <SheetContent side="left" className="sm:max-w-md w-full p-0 border-r">

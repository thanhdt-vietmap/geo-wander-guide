...
export class ServerHMACService {
  ...
  public verifyHMAC(method: string, url: string, timestamp: number, receivedSignature: string, body?:string): boolean {
    ...
    const expectedSignature = this._0x4d8a(method, 'maps.vietmap.vn', timestamp, body);
  ...
  public _0x3m8q = this.generateHMAC.bind(this);
  public _0x7h2w = this.generateAuthHeaders.bind(this);  
  public _0x9k5r = this.validateResponse.bind(this);
}
